    ...
    public static void getProduct(String url) throws XPatherException, MalformedURLException, IOException, SQLException{ 
       ...
       Db mysqlConn = new Db();
        ...
        try{
             ...
             String imgurl = "http://anf.scene7.com/is/image/anf/anf_" + webcode + "_" + seq + "_prod1?$anfCategoryJPG$";
             String imgpath = long_sku_id + ".jpg";
             
             readHTML.saveImage(imgurl, "C:\\Users\\xxkyh_000\\Desktop\\pics\\", imgpath);
